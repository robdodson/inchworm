...
{
	/**
	 * Interal state which governs the Player's behavior as it is buffering
	 * @author Justin Gaussoin
	 * @author Rob Dodson
	 * 
	 */	
	public class BufferState implements IVideoState
	{
		//————————————————————————————————————————————————————————————————
		// CLASS MEMBERS
		 ...
		 * 
		 */		
		public function BufferState(player:VideoPlayer)
		{
			this._player = player;
		}
